const AddBoard = ({ register, handleSubmit, createBoardHandler }) => {
    return (
        <>
            <label
                htmlFor="my-modal-3"
                className="card card-compact p-0 shadow-xl image-full cursor-pointer"
            >
                {/* <figure><img src="https://placeimg.com/400/225/arch" alt="Shoes" /></figure> */}
                <div className="card-body">
                    <h3 className="text-lg font-semibold">Add Team</h3>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleSubmit(createBoardHandler)}>
                        ...
                        <button type="submit" className="btn btn-sm w-full mt-4">
                            Add
                        </button>
                    </form>
                </div>
