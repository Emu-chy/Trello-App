...
const ManageBoard = () => {
    ...
    return (
        <div className="container mx-auto my-10 px-10">
            <h1 className="text-xl font-bold mb-4">Manage Team</h1>
            ...
            <div className="flex flex-wrap gap-y-2 gap-x-2 lg:gap-x-0  lg:justify-between mt-10">
                <div className="btn-group">
                    <button onClick={filterHandler} className="btn btn-active btn-sm text-xs">
                        All
                    </button>
                    <button onClick={filterHandler} className="btn btn-sm text-xs">
                        Running
                    </button>
                    <button onClick={filterHandler} className="btn btn-sm text-xs">
                        Completed
                ...
                <div className="btn-group">
                    <button
                        form="boardManageForm"
                        type="submit"
                        className="btn btn-sm bg-rose-700 border-rose-700 text-xs hover:bg-rose-800 hover:border-rose-900"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            {view === "grid" ? (
                <form id="boardManageForm" onSubmit={handleSubmit(deleteGridSelectedItemHandler)}>
                    <GridView
                ...
                <form id="boardManageForm" onSubmit={handleSubmit(deleteTableSelectedItemHandler)}>
                    <TableView
                        backup={myAllBoard}
                        selectAll={selectAll}
                        register={register}
